...
if(!file_exists('config.json')){
	$token = readline('HI start PRO Enter Token: ');
	$id = readline('HI start PRO Enter Id: ');
      ...
      $accounts = json_decode(file_get_contents('accounts.json'),1);
			if(isset($update->message)){
              ...
              $bot->sendphoto([ 'chat_id'=>$chatId,
                  'photo'=>"https://t.me/hdjdvdjjie8/2",
                   'caption'=>'تم الفعيل بواسطة NOVA (@M_a0z) ' ,
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'تسجيل حساب وهمي في البوت 🏃‍♂','callback_data'=>'login']],
                          [['text'=>"المطور",'url'=>"https://t.me/M_a0z"]],
                        ]   
                     ])
                  ]);
                  ...
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          ...
                          [['text'=>'⏸ بدء الصيد','callback_data'=>'run'],['text'=>'▶️ ايقاف الصيد','callback_data'=>'stop']],
                              ...
                              [['text'=>' مطور البوت','url'=>'t.me/M_a0z'],['text'=>' قناتي ','url'=>'t.me/hack151']],
                      ]
                  ])
                  ]);
          		    $config['mode'] = null;
...
اضغط في الاسفل لمراسله المطور 💡",
							'reply_markup'=>json_encode([
                  'inline_keyboard'=>[
                      [['text'=>'اضغط لمراسله المطور 🕸','url'=>'t.me/M_a0z']]
					  [['text'=>"▪️| قناه صيد المشتركين", 'url'=>"t.me/hack151"]],
                  ]
							])
					]);
				}
